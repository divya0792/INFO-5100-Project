...
import m1.team14.controller.SecondHalfController;

public class SecondHalfViewPanel extends JFrame implements IViewPanel {
  private SecondHalfController secondHalfController;
  private JButton btn;
  private JTextField textField;
  private JLabel label;
  private static final long serialVersionUID = 4L;

  public SecondHalfViewPanel(SecondHalfController secondHalfController) {
    this.secondHalfController = secondHalfController;
    this.initComponent();
  ...
  private void initComponent() {
    ...
    this.btn.addActionListener(e -> {
      this.secondHalfController.changeStyle(this.textField.getText());
    });
